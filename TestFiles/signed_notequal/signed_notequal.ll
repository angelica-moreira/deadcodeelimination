; ModuleID = '<stdin>'
source_filename = "TestFiles/signed_notequal/signed_notequal.c"
...
while.cond1:                                      ; preds = %while.cond, %while.body3
  %k.0 = phi i32 [ %inc5, %while.body3 ], [ 0, %while.cond ]
  %cmp2 = icmp slt i32 %k.0, 100
  br i1 %cmp2, label %while.body3, label %while.cond7

while.body3:                                      ; preds = %while.cond1
  %vSSA_sigma2 = phi i32 [ %k.0, %while.cond1 ]
  %call4 = call i32 (...) @notrem()
  %inc5 = add nsw i32 %vSSA_sigma2, 1
  br label %while.cond1

while.cond7:                                      ; preds = %while.cond1, %while.body9
  %j.0 = phi i32 [ %inc11, %while.body9 ], [ 0, %while.cond1 ]
  %cmp8 = icmp slt i32 %j.0, 100
  br i1 %cmp8, label %while.body9, label %while.cond13

while.body9:                                      ; preds = %while.cond7
  %vSSA_sigma4 = phi i32 [ %j.0, %while.cond7 ]
  %call10 = call i32 (...) @notrem()
  %inc11 = add nsw i32 %vSSA_sigma4, 1
  br label %while.cond7

while.cond13:                                     ; preds = %while.cond7, %while.body15
  %l.0 = phi i32 [ %inc17, %while.body15 ], [ 0, %while.cond7 ]
...
while.body15:                                     ; preds = %while.cond13
  ...
  %call16 = call i32 (...) @notrem()
  %inc17 = add nsw i32 %vSSA_sigma6, 1
...
if.then:                                          ; preds = %while.cond19
  ...
  %call48 = call i32 (...) @notrem()
  %call53 = call i32 (...) @notrem()
  %call62 = call i32 (...) @notrem()
  %call65 = call i32 (...) @notrem()
  ret i32 0
}
